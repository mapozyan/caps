...
from calibre_plugins.caps.urllib3.exceptions import ReadTimeoutError, SSLError as UrllibSSLError
from calibre_plugins.caps.urllib3.util.retry import Retry
import warnings
